...
urlpatterns = [
    ...
    path('recruitment/<username>/<int:recruitment_id>/', views.RecruitmentDetailView.as_view(),
    ...
    path('recruitment/<username>/edit/<int:recruitment_id>/', views.RecruitEditView.as_view(), name='edit_recruitment'),
    ...
    path('mypage/recruitment/<int:recruitment_id>/delete/', views.RecruitmentDeleteView.as_view(),
